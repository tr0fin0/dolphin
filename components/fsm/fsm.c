...
static const fsm_table_t fsm_table[NUMBER_OF_STATES] = {
    [STATE_ATTACK] = {
        ...
        .on_run = attack_run,
        .on_exit = attack_exit},
    [STATE_BOOT] = {.name = "BOOT", .on_entry = boot_entry, .on_run = boot_run, .on_exit = NULL},
    [STATE_COUNTDOWN] = {.name = "COUNTDOWN", .on_entry = countdown_entry, .on_run = countdown_run, .on_exit = NULL},
    [STATE_MANUAL] = {.name = "MANUAL", .on_entry = manual_entry, .on_run = manual_run, .on_exit = manual_exit},
    [STATE_OPENING] = {
        .name = "OPENING",
    ...
    [STATE_SAFE] = {.name = "SAFE", .on_entry = safe_entry, .on_run = safe_run, .on_exit = NULL},
    [STATE_SEARCH] = {.name = "SEARCH", .on_entry = search_entry, .on_run = search_run, .on_exit = NULL},
    [STATE_SURVIVE] = {.name = "SURVIVE", .on_entry = survive_entry, .on_run = survive_run, .on_exit = NULL}};
